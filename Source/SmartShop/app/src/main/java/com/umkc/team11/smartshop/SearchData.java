...
public class SearchData extends SQLiteOpenHelper
{
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase)
    {
        ...
        addListItem("Cotton Hardware Dress", "Karen Scott", 44.50, "XXL", "Macys", "Comfy in cotton, Karen Scott's sheath dress is seamed along the neckline and finished with delicate hardware details\n" +
                "Knee length\n" + "Scoop neckline with hardware detail\n" + "3/4-sleeves\n" + "Unlined\n" + "All cotton\n" + "Machine washable\n" + "Imported", "Blue", "CottonHardwareDress");
        addListItem("Ruffle-Hem Fit and Flare Dress","Bar III", 79.50, "0, 2, 4, 6, 8, 10, 12", "Macys", "Romanticized by ruffles and chic bishop sleeves, this fit and flare dress from Bar III is designed as a go-to piece for every occasion\n" +
                "Hidden back zipper closure\n" + "Short length\n" + "Scoop neckline; fit and flare silhouette\n" + "Long bishop sleeves\n" + "Ruffled hem\n" + "Unlined\n" + "Rayon, lining: polyester\n" + "Machine washable\n" + "Imported",
                "Blue", "RuffleHemFlareDress");
        addListItem("Embellished Dress and Duster Jacket", "R and M Richards", 109.00, "6, 8, 10, 12, 14, 16, 18", "Macys", "R and M Richards' elegant mesh-pleated duster jacket looks simply ravishing over a sophisticated occasion dress embellished at the scoop\n" +
        ...
        addListItem("Women's Short Sleeve V-Neck Wrap Dress", "Xhilaration", 24.99, "XS, S, M, L, XL, XXL", "Target", "A look that can take you from day to night — this Short-Sleeve Surplice Wrap Dress from Xhilaration brings just the right amount of casual comfort mixed with sweet elements\n" +
        ...
        addListItem("Women's Ponte Fit and Flare Dress", "A New Day", 24.99, "XL, XXL", "Target", "For a stylish piece that you can wear for any occasion, from work to dinner dates to running errands, look no further than this Ponte Fit and Flare Dress from A New Day\n" +
        ...
        addListItem("Young Men's Performance Polo", "Dickies", 15.99, "S, M, L, XL", "Target", "Your little guy will love the comfort and ease of wearing this Performance Polo from Dickies\n" +
        ...
        addListItem("Women's Long Sleeve Pocket Casual Loose T-Shirt Dress", "Unbranded", 18.99, "S, M, L, XL", "Amazon", "This super comfy jersey knit dress has a rounded neckline and long sleeve with hidden side seam pockets\n" +
                ...
                "Fabric: Fabric is very stretchy ", "Black", "LongSleevePocketCasualDress");
        addListItem("Women's Casual Flare Floral Contrast Evening Party Mini Dress", "Miusol", 25.99, "S, M, L, XL, XXL", "Amazon", "60% Rayon, 34% Nylon, 6% Spandex\n" + "Imported\n" + "Deep V-Neck, Sleeveless\n" +
        ...
        addListItem("Men's X-Temp Performance Polo Shirt", "Hanes", 33.50, "S ,M, L, XL, XXL ,XXXL", "Amazon", "Imported\n" + "Machine Wash\n" + "Short-sleeve polo with three-button placket and tag-free labeling\n" +
        ...
        addListItem("Men's Advantage Performance Solid Polo", "IZOD", 79.91, "S, M, L, XL, XXL", "Amazon", "60% Cotton, 40% Polyester\n" + "Imported\n" + "Button closure\n" +
    ...
    private void addListItem(String name, String creator, double price, String size, String store, String description, String color, String image)
    {
